...
{
    public class GetTeamsWithStatsWithPaginationQueryValidator : AbstractValidator<GetTeamsWithStatsWithPaginationQuery>
    {
        public GetTeamsWithStatsWithPaginationQueryValidator()
        {

...
{
    public class GetTeamsEloRankingsWithPaginationQueryValidator : AbstractValidator<GetTeamsEloRankingsWithPaginationQuery>
    {
        public GetTeamsEloRankingsWithPaginationQueryValidator()
        {

...
{
    public class GetTichuCallsWithPaginationQueryValidator : AbstractValidator<GetTichuCallsWithPaginationQuery>
    {
        public GetTichuCallsWithPaginationQueryValidator()
        {

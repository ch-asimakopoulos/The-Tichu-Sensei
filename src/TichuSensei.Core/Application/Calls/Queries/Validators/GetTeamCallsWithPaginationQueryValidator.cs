...
{
    public class GetTeamCallsWithPaginationQueryValidator : AbstractValidator<GetTeamCallsWithPaginationQuery>
    {
        public GetTeamCallsWithPaginationQueryValidator()
        {

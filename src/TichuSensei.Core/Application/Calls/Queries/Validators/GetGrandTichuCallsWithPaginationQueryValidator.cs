...
{
    public class GetGrandTichuCallsWithPaginationQueryValidator : AbstractValidator<GetGrandTichuCallsWithPaginationQuery>
    {
        public GetGrandTichuCallsWithPaginationQueryValidator()
        {

...
{
    public class GetPlayersWithStatsWithPaginationQueryValidator : AbstractValidator<GetPlayersWithStatsWithPaginationQuery>
    {
        public GetPlayersWithStatsWithPaginationQueryValidator()
        {

...
{
    public class GetGamesWithStatsWithPaginationQueryValidator : AbstractValidator<GetGamesWithStatsWithPaginationQuery>
    {
        public GetGamesWithStatsWithPaginationQueryValidator()
        {
